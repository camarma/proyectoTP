...
public abstract class NoParamNoOperandInstruction implements Instruction{
	...
	public boolean execute(OperandStack stack, Memory memory, ControlUnit control){
		try {
			return operate(stack, memory, control);
	 ...
	 */
	protected abstract boolean operate(OperandStack stack, Memory memory, ControlUnit control) throws InstructionsException;

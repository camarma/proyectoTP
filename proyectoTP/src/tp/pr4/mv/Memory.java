...
public class Memory {
	...
	public boolean canLoad(int pos) throws MemoryException{
		if (MemoriaVacia()){
			...
			throw new MemoryException("Direccion de memoria incorrecta, no se puede cargar la posición:", pos);
		}
	}
	...
	public boolean store(int pos,int value) throws MemoryException{		
		if(pos<0){
			throw new MemoryException("Posicion incorrecta:"+pos);
		}
		else{
	...
	/**
	 * Método en cargao de comprobar si la memoria sta vacía.

...
public abstract class TwoParamNoOperandInstruction implements Instruction{
	...
	public void execute(OperandStack stack, Memory memory, ControlUnit control) throws InstructionsException{
		try {
			operate(stack, memory, control, param1, param2);
	 ...
	 * @throws InstructionsException 
	 */
	protected abstract void operate(OperandStack stack, Memory memory, ControlUnit control, int param1, int param2) throws InstructionsException;
